...
export default function EditProductForm({product}:Props) {
  ...
  const [inputDate, setInputDate] = useState(product.expiration_date + 'T00:00:00-03:00')

  const [inputPrice, setInputPrice] = useState(product.price)

  const [checkboxPromotion, setCheckboxPromotion] = useState(product.promotion)

  const [selectCategory, setSelectCategory] = useState(product.category.id)
